...
import { RefreshCw, Loader2, FileSearch, CheckCircle2, Clock3, XCircle, ChevronRight, Upload, Paperclip, Download, Search, Lock } from "lucide-react";
...
export const Route = createFileRoute("/operator/")({
  ...
  // The shell carries the portal guard; no page-level guard needed.
  component: () => <OperatorShell><OperatorPortal /></OperatorShell>,
});
