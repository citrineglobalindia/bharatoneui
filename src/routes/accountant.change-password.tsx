...
export const Route = createFileRoute("/accountant/change-password")({
  head: () => ({ meta: [{ title: "Change Password — BharatOne Accountant" }] }),
...
function ChangePasswordPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => navigate({ to: "/accountant/dashboard" }), 600);
    }, 800);
  };
        ...
        <form onSubmit={handleSubmit} className="rounded-xl border border-border bg-card p-5 shadow-soft space-y-4">
            ...
            <div key={f.label}>
              ...
              <div className="mt-1 relative">
                <input
                  ...
                  className="w-full rounded-lg border border-input bg-background pl-3 pr-10 h-10 text-sm shadow-soft focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-emerald-500/15 focus-visible:border-emerald-500"
                />
          ...
          <div className="flex items-center justify-between pt-2 border-t">
            ...
            <div className="flex gap-2">
              <Button type="button" variant="outline" onClick={() => navigate({ to: "/accountant/dashboard" })}>Cancel</Button>
