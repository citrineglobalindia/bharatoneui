  ...
  return (
    ...
    <div className="space-y-6">
      <StepHeader
        ...
        description="Enter your email and verify it via OTP to continue."
      />
      ...
      {emailVerified && (
        <div className="flex items-start gap-3 rounded-2xl border border-emerald-200 bg-gradient-to-br from-emerald-50/80 to-white p-4">
          ...
          <div>
            <h3 className="font-display text-sm font-bold text-foreground">Email verified successfully</h3>
            <p className="mt-0.5 text-[12px] text-muted-foreground">
              Your email has been verified. Click <span className="font-semibold text-foreground">Next</span> to continue.
            </p>
          </div>
        </div>
      )}
