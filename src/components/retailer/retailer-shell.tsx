...
const NAV: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Money Transfer", icon: <ArrowLeftRight className="h-4 w-4" />, to: "/money-transfer", moduleKey: "retailer.dmt" },
...
const SEARCH_DESTS: { label: string; to: string; kw: string }[] = [
  ...
  { label: "Recharge & Bills", to: "/bbps", kw: "bbps bill payment recharge mobile prepaid electricity dth gas broadband bharat connect" },
  { label: "Money Transfer", to: "/money-transfer", kw: "dmt money transfer remittance send money imps neft beneficiary account ifsc" },
