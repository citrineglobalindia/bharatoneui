...
const NAV: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "New Application", icon: <PlusCircle className="h-4 w-4" />, to: "/new-service-request", children: [
        { label: "B2C Services", to: "/new-service-request?group=b2c" },
        { label: "G2C Services", to: "/new-service-request?group=g2c" },
        { label: "State Government Services", to: "/new-service-request?group=state_gov" },
        { label: "Central Government Services", to: "/new-service-request?group=central_gov" },
        { label: "Internal Links", to: "/new-service-request?group=internal_links" },
        { label: "BharatOne Mart - Separate KYC", to: "/new-service-request?group=mart" },
      ] },
    ...
    <div className="flex h-full flex-col">
      ...
      <div className="px-4 py-3 border-b border-border flex items-center gap-3">
        ...
        <div className="min-w-0">
          ...
          {me.phone && <p className="text-[11px] text-muted-foreground truncate">{me.phone}</p>}
