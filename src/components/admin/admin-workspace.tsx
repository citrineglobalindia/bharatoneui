...
const NAVIGATION: NavGroup[] = [
  ...
  { label: "Platform", items: [{ label: "Service Catalog", icon: Zap }, { label: "Service Pricing", icon: BadgeIndianRupee }, { label: "Support Center", icon: Headphones }, { label: "System Settings", icon: Settings }, { label: "Feedback", icon: MessageSquare }, { label: "Audit Log", icon: FileClock }] },
];
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        <main className="flex-1 overflow-y-auto">
          <div className="mx-auto max-w-[1700px] space-y-5 p-4 lg:p-6 xl:p-7">
            ...
            </> : active === "Audit Log" ? <AdminAuditLog /> : active === "User Management" ? <AdminUsers /> : active === "Service Catalog" ? <ServicesManager /> : active === "Service Pricing" ? <CatalogManager /> : active === "Applications" ? <ServiceApplicationsView /> : active === "Roles & Permissions" ? <RolePermissionCenter /> : active === "Accountant Operations" ? <RegistrationsReview /> : active === "QC Operations" ? <RegistrationsReview /> : active === "KYC Approvals" ? <RegistrationsReview /> : active === "DRO Operations" ? <RegionalOperations role="DRO" /> : active === "TRO Operations" ? <RegionalOperations role="TRO" /> : active === "Retailer Network" ? <RetailerNetworkCenter /> : active === "System Settings" ? <div className="space-y-5"><AccountProfile /><AccountSettings /></div> : active === "Feedback" ? <FeedbackPanel /> : <AdminModuleView module={active} />}
          </div>
        </main>
      </div>
    </div>
