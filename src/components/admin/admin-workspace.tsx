...
const NAVIGATION: NavGroup[] = [
  ...
  { label: "Finance", items: [{ label: "Accountant Operations", icon: Landmark }, { label: "Wallet Control", icon: WalletCards }, { label: "Revenue Analytics", icon: BarChart3 }, { label: "Settlements", icon: Landmark }, { label: "Application Ledger", icon: WalletCards }, { label: "Wallet & Top-ups", icon: Wallet }, { label: "Risk & Fraud", icon: ShieldCheck, badge: "8" }] },
