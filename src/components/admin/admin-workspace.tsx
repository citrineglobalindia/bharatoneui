...
const NAVIGATION: NavGroup[] = [
  ...
  { label: "Network", items: [{ label: "User Management", icon: Users }, { label: "KYC Approvals", icon: ClipboardCheck, badge: "116" }, { label: "DRO Operations", icon: MapPin }, { label: "TRO Operations", icon: MapPin }, { label: "Applications", icon: FileSearch }, { label: "Retailer Network", icon: Store }, { label: "Roles & Permissions", icon: LockKeyhole }] },
