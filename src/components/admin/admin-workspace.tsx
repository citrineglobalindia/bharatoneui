...
const NAVIGATION: NavGroup[] = [
  ...
  { label: "Platform", items: [{ label: "Service Catalog", icon: Zap }, { label: "Old JSKO IDs", icon: IdCard }, { label: "Support Center", icon: Headphones }, { label: "System Settings", icon: Settings }, { label: "Feedback", icon: MessageSquare }, { label: "Audit Log", icon: FileClock }] },
];
