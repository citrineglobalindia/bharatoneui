      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        <main className="flex-1 overflow-y-auto">
          <div className="mx-auto max-w-[1700px] space-y-5 p-4 lg:p-6 xl:p-7">
            ...
            </> : active === "Audit Log" ? <AdminAuditLog /> : active === "User Management" ? <AdminUsers /> : active === "Service Catalog" ? <CatalogManager /> : active === "Old JSKO IDs" ? <JskoManager /> : active === "Applications" ? <ServiceApplicationsView /> : active === "Application Ledger" ? <ApplicationLedger /> : active === "Wallet & Top-ups" ? <WalletAdmin /> : active === "Withdrawals" ? <WithdrawalsAdmin /> : active === "Roles & Permissions" ? <RolePermissionCenter /> : active === "Accountant Operations" ? <RegistrationsReview /> : active === "KYC Approvals" ? <RegistrationsReview /> : active === "DRO Operations" ? <RegionalOperations role="DRO" /> : active === "TRO Operations" ? <RegionalOperations role="TRO" /> : active === "Retailer Network" ? <RetailerNetworkCenter /> : active === "Distributors" ? <DistributorAdmin /> : active === "Retailer Map" ? <RetailerMap scope="admin" /> : active === "System Settings" ? <div className="space-y-5"><AccountProfile /><AccountSettings /></div> : active === "Support Center" ? <SupportAdmin /> : active === "Live Chat" ? <LiveChatAdmin /> : active === "Feedback" ? <FeedbackPanel /> : <AdminModuleView module={active} />}
          </div>
        </main>
      </div>
    </div>
