      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        <main className="flex-1 overflow-y-auto">
          <div className="mx-auto max-w-[1700px] space-y-5 p-4 lg:p-6 xl:p-7">
            ...
            </> : active === "Audit Log" ? <AdminAuditLog /> : active === "User Management" ? <UserManagementWorkflow /> : active === "Service Catalog" ? <ServiceCatalogBuilder /> : active === "Roles & Permissions" ? <RolePermissionCenter /> : <AdminModuleView module={active} />}
          </div>
        </main>
      </div>
    </div>
