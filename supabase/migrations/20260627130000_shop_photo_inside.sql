-- CR-6: capture a separate Inside Shop Photo (existing shop_photo_path stays the Outside/signboard photo).
alter table public.retailer_registrations add column if not exists shop_photo_inside_path text;
